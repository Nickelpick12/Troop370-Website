...
@Component({
  selector: 'app-scout-resourses',
  templateUrl: './scout-resourses.component.html',
  styleUrls: ['./scout-resourses.component.css']
})
export class ScoutResoursesComponent implements OnInit {
