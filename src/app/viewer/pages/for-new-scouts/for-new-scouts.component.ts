...
@Component({
  selector: 'app-for-new-scouts',
  templateUrl: './for-new-scouts.component.html',
  styleUrls: ['./for-new-scouts.component.css']
})
export class ForNewScoutsComponent implements OnInit {
